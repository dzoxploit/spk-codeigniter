...
<head>
    ...
    <link href="<?= base_url("assets/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css") ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<![endif]-->
    <script src="<?= base_url("assets/assets/libs/jquery/dist/jquery-3.6.0.min.js") ?>"></script>
</head>