            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3 pb-3 border-bottom">Form Tambah Kriteria</h4>
                                <form action="<?= site_url('kriteria/kriteria_insert'); ?>" method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-floating mb3">
                                                <input type="text" name="namaKriteria" id="namaKriteria" class="form-control" placeholder="Nama Kriteria..." required>
