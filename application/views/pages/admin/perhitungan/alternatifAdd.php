                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?= site_url('perbandingan/alternatif_insert'); ?>" method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group mb-4">
                                                <label for="kost">Kost</label>
                                                <select name="kost" class="form-select me-sm-2" required>
                                                    <option value="" selected>Pilih Kost</option>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="luas" class="form-select me-sm-2" required>
                                                    <option value="" selected>Pilih Luas Kamar</option>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="keamanan" class="form-select me-sm-2" required>
                                                    <option value="" selected>Pilih Keamanan</option>
