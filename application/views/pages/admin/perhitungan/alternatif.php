        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <a href="<?= site_url('alternatif/add') ?>" class="justify-content-center btn btn-info text-white align-items-center">
                                            ...
                                            <td>
                                                <div class="dropdown dropright">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a href="<?php echo site_url('alternatif/edit/' . $row->id); ?>" class="dropdown-item">Edit</a></li>
                                                        <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#al-danger-alert-<?php echo $row->id; ?>">Hapus</button></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <div class="modal fade" id="al-danger-alert-<?php echo $row->id; ?>" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content modal-filled bg-light-danger">
                                                        <div class="modal-body p4">
                                                            <div class="text-center text-danger">
                                                                ...
                                                                <a href="<?php echo site_url('alternatif/delete/' . $row->id); ?>" class="btn btn-light my-2">
                                                                    Hapus Data
                                                                </a>
                                                            </div>
                                                        </div>
