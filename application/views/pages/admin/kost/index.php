        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <a href="<?= site_url('kost/add') ?>" class="justify-content-center btn btn-info text-white align-items-center">
                                            ...
                                            <td>
                                                <div class="dropdown dropright">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a href="<?php echo site_url('kost/edit/' . $row->slug); ?>" class="dropdown-item">Edit</a></li>
                                                    ...
                                                    <div class="modal-content modal-filled bg-light-danger">
                                                        <div class="modal-body p4">
                                                            <div class="text-center text-danger">
                                                                ...
                                                                <a href="<?php echo site_url('kost/delete/' . $row->slug); ?>" class="btn btn-light my-2">
                                                                    Hapus Data
                                                                </a>
                                                            </div>
                                                        </div>
