            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3 pb-3 border-bottom">Form Edit Kost</h4>
                                <form action="<?= site_url('kost/kost_update'); ?>" method="post">
                                    <?php foreach ($kost as $row) { ?>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-floating mb3">
                                                    <input type="hidden" name="slug" value="<?= $row->slug; ?>">
                                                    <input type="text" name="namaKost" id="namaKost" class="form-control" value="<?= $row->kost; ?>" required>
