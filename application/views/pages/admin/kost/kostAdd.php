                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="<?= site_url('kost') ?>" class="link">Kost</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-3 pb-3 border-bottom">Form Tambah Kost</h4>
                                <form action="<?= site_url('kost/insert'); ?>" method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-floating mb3">
                                                <input type="text" name="namaKost" id="namaKost" class="form-control" placeholder="Nama Kost..." required>
                                                <label for="namaKost">Nama Kost</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-md-flex align-items-center mt-3 float-end">
                                                <a href="<?= site_url('kost') ?>" class="btn btn-outline-secondary waves-effect waves-light rounded-pill px-4 mx-2">
                                                    Batal
                                                </a>
